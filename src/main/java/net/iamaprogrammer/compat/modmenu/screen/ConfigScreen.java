package net.iamaprogrammer.compat.modmenu.screen;

import net.iamaprogrammer.ExtendedPickingClient;
import net.iamaprogrammer.compat.modmenu.widgets.IntSliderWidget;
import net.iamaprogrammer.config.core.Config;
import net.iamaprogrammer.config.core.ConfigUtil;
...
public class ConfigScreen<C extends Config> extends Screen {
    ...
    private ButtonWidget saveButton() {
        return ButtonWidget.builder(ScreenTexts.DONE, button -> {
            ...
            if (!ConfigUtil.save(this.config)) {
                ExtendedPickingClient.LOGGER.error("Could not save config.");
            } else {
    ...
    private ButtonWidget cancelButton() {
        return ButtonWidget.builder(ScreenTexts.CANCEL,
